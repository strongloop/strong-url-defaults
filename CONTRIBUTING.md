...
Thank you for your interest in `strong-url-defaults`, an open source project
administered by StrongLoop.

Contributing to `strong-url-defaults` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-url-defaults)
